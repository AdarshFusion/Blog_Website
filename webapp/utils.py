...
def send_test_email(email):
    subject = "Welcome to Think Smart – Your Gateway to Knowledge!"
    message = """
    Hi there!
    
    Welcome to Think Smart! We’re thrilled you’ve joined our community of curious minds and lifelong learners.
